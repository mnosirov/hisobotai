...
async def get_sales_summary(
    ...
    try:
        ...
        return {
            **sales_summary,
            "total_stock_cost": bi_summary.get("total_stock_cost", 0) if (year is None or year == 0) else dash_sum.get("inventory_in_cost", 0),
            "total_stock_sell": bi_summary.get("total_stock_sell", 0) if (year is None or year == 0) else dash_sum.get("inventory_in_sell", 0),
            "total_sales_revenue": dash_sum.get("revenue", 0),
            "total_expenses": dash_sum.get("expenses", 0),
            "today_profit": dash_sum.get("profit", 0) if (year is not None and year != 0) else sales_summary.get("today_profit", 0),
